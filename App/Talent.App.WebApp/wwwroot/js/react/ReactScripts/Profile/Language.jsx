...
export default class Language extends React.Component {
    ...
    deleteLanguage(data) {
        ...
        $.ajax({
            url: 'https://talentproject3.azurewebsites.net/profile/profile/deleteLanguage',
    ...
    updateLanguage() {
        ...
        $.ajax({
            url: 'https://talentproject3.azurewebsites.net/profile/profile/updateLanguage',
    ...
    addLanguage() {
        ...
        if (!name || !level) {
            ...
            $.ajax({
                url: 'https://talentproject3.azurewebsites.net/profile/profile/addLanguage',
    ...
    renderEdit() {
        ...
        let languageOption = ["Basic", "Conversational", "Fluent", "Native/Bilingual"]
    ...
    renderAdd() {
        ...
        let selectedLanguage = this.state.newContact.language
